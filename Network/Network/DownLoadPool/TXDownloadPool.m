...
@interface TXDownloadPool()
@property (nonatomic,strong) NSString  *fileHistoryPath;
@end


@implementation TXDownloadPool

+ (instancetype)shared {
    static TXDownloadPool *single = nil;
...
- (instancetype)init {
    ...
    NSURLSessionConfiguration *config = [NSURLSessionConfiguration backgroundSessionConfigurationWithIdentifier:@"com.luochaojing.download.id.001"];
    config.timeoutIntervalForRequest = 30;
    config.allowsCellularAccess = YES;// 蜂窝网
